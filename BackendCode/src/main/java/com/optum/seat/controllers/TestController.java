...
//			emailSenderService.sendEmail(email, "Booking Confirmation" , "You have successfully booked slot "
//					+ allBookingTransaction.getSlotTime() +  " for the date " + allBookingTransaction.getDateOfTransaction()+ " at location " + code +  ". Your Booking ID is " + trx.toString());
//			
			return "You have successfully booked for a slot. Your Booking ID is " + trx.toString();
